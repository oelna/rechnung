function _getTypeNumber (sText, nCorrectLevel) {			
	...
	const QRCodeLimitLength = QRCode.QRCodeLimitLength;
...
class QRRSBlock {
	...
	constructor (totalCount, dataCount) {
		...
		this.RS_BLOCK_TABLE = QRRSBlock.RS_BLOCK_TABLE;
...
class QRMode {
	static MODE_NUMBER = 1 << 0;
	static MODE_ALPHA_NUM = 1 << 1;
	static MODE_8BIT_BYTE = 1 << 2;
	static MODE_KANJI = 1 << 3;
}
...
class QRCode {
	...
	constructor (el, vOption) {
		...
		// end QRCodeModel
		this.QRCodeLimitLength = QRCode.QRCodeLimitLength;

		this.svgDrawer = Drawing;
